...
5. For each output CSV file listed above, add a short section titled \
"Output Files" that describes what the file contains and what each column means \
in plain business language (not solver jargon)
